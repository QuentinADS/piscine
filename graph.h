...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetBox m_box_ajouter;
        grman::WidgetButton m_b1;
        grman::WidgetText m_t1;

        grman::WidgetBox m_box_sauver;
        grman::WidgetButton m_b2;
        grman::WidgetText m_t2;

        grman::WidgetBox m_box_menu;
        grman::WidgetButton m_b5;
        grman::WidgetText m_t5;

        grman::WidgetBox m_box_ajouter2;
        grman::WidgetButton m_b6;
        grman::WidgetText m_t6;

        grman::WidgetBox m_box_connexite;
        grman::WidgetButton m_b7;
        grman::WidgetText m_t7;

        grman::WidgetButton m_supp;
        grman::WidgetText m_t4;

        grman::WidgetButton m_b8;
        grman::WidgetText m_t8;

        grman::WidgetButton m_b9;
        grman::WidgetText m_t9;
...
class Graph
{
    private :
        ...
        ///Tableau dynamique indiquant les composantes fortements connexes
        int** m_connexite;

        ///idx d'une arete pour eviter les pb de collisions
        int m_nbEdges;
    ...
    public:
        ...
        void ajouter_sommet();
        void ajouter_arete();
        void affichage_adjacence();

        void evolution();

        int* UneComposanteFortementConnexe(int s);
        void ToutesLesComposantesFortementsConnexes();
